...
### After the prepare-command, the label line is changed
### the acutal value is the base64 encoded of apb.yml file
# apb prepare
# apb build

# docker images
REPOSITORY                                               TAG                 IMAGE ID            CREATED             SIZE
my-test-apb                                              latest              c846061344d4        22 minutes ago      655 MB
registry.reg-aws.openshift.com:443/openshift3/apb-base   latest              6511ecc69805        5 months ago        655 MB

### https://docs.openshift.com/container-platform/3.9/apb_devel/cli_tooling.html#apb-devel-cli-install-prereqs-access-permissions
# oc adm policy add-cluster-role-to-user cluster-admin redhat
# oc login -u redhat -p redhat

# oc get route docker-registry -n default
NAME              HOST/PORT                                              PATH      SERVICES          PORT      TERMINATION   WILDCARD
docker-registry   docker-registry-default.apps.0516-2qy.qe.rhcloud.com             docker-registry   <all>     passthrough   None

# vi /etc/sysconfig/docker
### comment out this line
#INSECURE_REGISTRY='--insecure-registry registry.reg-aws.openshift.com:443'

# cat /etc/docker/daemon.json
{
  "insecure-registries" : [ "registry.reg-aws.openshift.com:443", "docker-registry-default.apps.0516-2qy.qe.rhcloud.com" ]
}

# systemctl restart docker

### This step is necessary for `apb list` command
# oc edit -n openshift-ansible-service-broker configMap broker-config
# oc delete pod -n openshift-ansible-service-broker asb-1-bj9rm
...
    ['openshift']\n    white_list: [.*]\n\ndao
...

# apb --debug push --registry-route docker-registry-default.apps.0516-2qy.qe.rhcloud.com
# apb list
Contacting the ansible-service-broker at: https://asb-1338-openshift-ansible-service-broker.apps.0516-2qy.qe.rhcloud.com/ansible-service-broker/v2/catalog
ID                                NAME                       DESCRIPTION
fa543a7dc6a77b93722490a22b8a0cc8  localregistry-my-test-apb  This is a sample application generated by apb init

### On openshift web console, we can see my-test is listed in `Other` tag.

### https://bugzilla.redhat.com/show_bug.cgi?id=1554145#c11
# oc delete pod -n openshift-ansible-service-broker asb-1-bj9rm
...
    true\n  bootstrap_on_startup
...
# apb --debug remove --id fa543a7dc6a77b93722490a22b8a0cc8
### It should be deleted on the web console too
### OR, we can check by svcat cli (see below how to install it)
# svcat get classes | grep my-test
  localregistry-my-test-apb                       This is a sample application generated by apb init 
