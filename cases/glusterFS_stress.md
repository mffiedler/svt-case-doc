...
Or, label a node with `aaa=ccc` for heketi:

```
oc patch -n default deploymentconfigs/registry-console --patch '{"spec": {"template": {"spec": {"nodeSelector": {"region": "infra"}}}}}'

oc patch -n default deploymentconfigs/registry-console --patch '{"spec": {"template": {"spec": {"nodeSelector": {"node-role.kubernetes.io/infra": "true"}}}}}'
...
| 20180118 | 3.9.0-0.21.0.git.0.2a50d06.el7 | rhel          | overlay2              | 3.3.0-362           | 3.3.0-364 | yes      | 1000                             | [link](http://pbench.perf.lab.eng.bos.redhat.com/results/EC2::ip-172-31-54-186/) or [link-ex](http://perf-infra.ec2.breakage.org/pbench/results/ip-172-31-54-186/) |
| 20180119 | 3.9.0-0.21.0.git.0.2a50d06.el7 | rhel          | overlay2              | 3.3.0-362           | 3.3.0-364 | yes      | 1448 X 3g PVC: no space          | [link](http://pbench.perf.lab.eng.bos.redhat.com/results/EC2::ip-172-31-9-109/) or [link-ex](http://perf-infra.ec2.breakage.org/pbench/results/ip-172-31-9-109/)   |
| 20180220 | 3.9.0-0.46.0.git.0.d03ead3.el7 | rhel + crio   | overlay2              | 3.3.0-362           | 3.3.0-364 | yes      | <70                              |                                                                                                                                                                    |
| 20180221 | 3.9.0-0.46.0.git.0.d03ead3.el7 | rhel + docker | overlay2              | 3.3.0-362           | 3.3.0-364 | yes      | 1989: one glusterfs pod restarts | [172-31-61-1](http://pbench.perf.lab.eng.bos.redhat.com/results/EC2::ip-172-31-61-1/)                                                                              |
| 20180313 | 3.9.4-1.git.0.35fdfc4.el7      | rhel + docker | overlay2              | 3.3.1-7;bp: 3.3.1-3 | 3.3.1-5   | no       | 1250: did not go further         | [172-31-61-1](http://pbench.perf.lab.eng.bos.redhat.com/results/EC2::ip-172-31-37-239/)                                                                            |
