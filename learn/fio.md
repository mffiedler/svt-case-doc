...
[2]. [ipos wiki](https://en.wikipedia.org/wiki/IOPS) and [ipos, throughput, and latency](http://searchsolidstatestorage.techtarget.com/definition/IOPS-Input-Output-Operations-Per-Second)
